...
class Client(object):
    ...
    def save_client_model(self):
        ...
        model_path = os.path.join(model_path, self.algorithm + "_client_" + str(self.id) + ".pt")
        torch.save(self.model, model_path)
        print(f"client {str(self.id)} saved")
    ...
    def load_item(self, item_name, item_path=None):
        if item_path == None:
            item_path = self.save_folder_name
        return torch.load(os.path.join(item_path, "client_" + str(self.id) + "_" + item_name + ".pt"), map_location='cpu')
