...
# === cc: fallback main guard to ensure training launches ===
if __name__ == '__main__':
    try:
        run(args)  # call the existing run() using parsed args in module scope
    except NameError:
        import argparse
        print('[!] args not found at module scope; please ensure parser.parse_args() executes before this block.')
