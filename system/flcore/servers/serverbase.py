...
class Server(object):
    def __init__(self, args, times):
        ...
        self.num_classes = args.num_classes      # 本次分类任务的类别数
        self.global_rounds = args.global_rounds  # 全局聚合轮次
        self.local_epochs = args.local_epochs    # 本地训练的最大轮次
    ...
    def load_model(self):
        ...
        self.global_model = torch.load(model_path, weights_only=False, map_location='cpu')
    ...
    def evaluate(self, acc=None, loss=None):
        ...
        self.temp_test_acc = test_acc # current epoch test acc
